...
def main(env,options):
    ...
    starttime = time.time()
    while True:
        velocities = [0, 10*(random.rand() - 0.5), 0, 1, 1, 1, 1]
...
def run(args=None):
    ...
    parser.add_option('--scene',action="store",type='string',dest='scene',default='GolfCart.Env.xml',
